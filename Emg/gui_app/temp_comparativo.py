...
sys.path.append("/home/lbraun/Repos/Nandu_SistemadeAdqusicionEMG/Emg")
import analisis_por_track_integrado as api

mediciones = ['2026-05-22/_E4_1_NONE _Sujeto2', '2026-05-22/_E4_2_TRENZADOMALLADOGND_Sujeto2']
base_dir = "/home/lbraun/Repos/Nandu_SistemadeAdqusicionEMG/Emg/base_de_datos_electrodos"
canal = "canal_0"
nombre_custom = "E4_1_NONE_vs_E4_2_TRENZADOMALLADOSINGND"
...
if len(resultados_globales) > 1:
    ...
    out_dir = os.path.join("/home/lbraun/Repos/Nandu_SistemadeAdqusicionEMG/Emg", "analisis_comparativos", today_str, nombre_carpeta)
