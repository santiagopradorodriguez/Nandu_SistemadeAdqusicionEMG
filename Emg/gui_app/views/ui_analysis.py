    ...
    def __init__(self):
        ...
        self.btn_run_comparativo.setStyleSheet("""
            QPushButton {
                ...
                color: white; font-weight: bold; font-size: 14px; border-radius: 6px;
            }
            QPushButton:hover { background-color: #218838; }
    ...
    def __init__(self):
        ...
        self.setStyleSheet("""
            ...
            QGroupBox {
                ...
                margin-top: 10px; padding-top: 10px; font-weight: bold; color: #ccc;
            }
            QGroupBox::title { subcontrol-origin: margin; subcontrol-position: top left; padding: 0 3px; }
            QLabel { color: #ccc; }
            QSpinBox, QDoubleSpinBox, QLineEdit, QComboBox {
                background-color: #2d2d2d; color: white; border: 1px solid #555; padding: 4px;
            }
            QTabWidget::pane { border: 1px solid #444; border-radius: 4px; background: #1e1e1e; }
            QTabBar::tab {
                background: #2d2d2d; color: #aaa; padding: 8px 15px; border: 1px solid #444;
