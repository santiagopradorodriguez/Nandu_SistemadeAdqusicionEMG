...
def ejecutar_procesamiento(mediciones, alpha_ruido=1.0, gate_ratio_ruido=8.0, snr_threshold=0.1, outlier_contamination=0.05, smooth_ms=120, notch_q=2.0, target_length=100, use_manual_exclusions=True, verbose=True, correccion_impedancia=True, **kwargs):
