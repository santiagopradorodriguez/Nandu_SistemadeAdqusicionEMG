...
class App:
    ...
    def open_comparisons_folder(self):
        ...
        win.title("Ñandú LSD - Explorador de Análisis Comparativos")
    ...
    def open_detail(self, measurement: Measurement):
        ...
        def on_tab_changed(event):
            try:
                ...
                channel = next((ch for ch in measurement.channels if ch.display_name.upper() == tab_text or ch.name.upper() == tab_text), None)
        ...
        for channel in measurement.channels:
            ...
            notebook.add(tab_frame, text=f"  {channel.display_name.upper()}  ")
